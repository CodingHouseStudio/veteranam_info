...
class FooterDescWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      key: KWidgetkeys.widgetKeys.footerKeys.widget,
        ...
        child: Column(
          children: [
            if (isDesktop)
              ...
              Column(
                ...
                children: [
                  Text(
                    KAppText.logo,
                    key: KWidgetkeys.widgetKeys.footerKeys.logo,
            ...
            Row(
              children: [
                IconWidget(
                  key: KWidgetkeys.widgetKeys.footerKeys.likedInIcon,
                  icon: KIcon.linkedIn,
                ),
                KSizedBox.kWidthSizedBoxSM,
                IconWidget(
                  key: KWidgetkeys.widgetKeys.footerKeys.instagramIcon,
                  icon: KIcon.instagram,
                ),
                KSizedBox.kWidthSizedBoxSM,
                IconWidget(
                  key: KWidgetkeys.widgetKeys.footerKeys.facebookIcon,
                  icon: KIcon.facebook,
                ),
              ],
            ),
...
class _FooterDescImplementationWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final buttonsKey =
        KWidgetkeys.widgetKeys.footerKeys.buttonsKey.elementAt(columnIndex);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
