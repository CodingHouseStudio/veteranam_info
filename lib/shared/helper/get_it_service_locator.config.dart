...
import 'package:kozak/components/home/bloc/home_watcher_bloc.dart' as _i19;
...
import 'package:kozak/components/investors/bloc/investors_watcher_bloc.dart'
    as _i16;
import 'package:kozak/components/login/bloc/login_bloc.dart' as _i25;
import 'package:kozak/components/sign_up/bloc/sign_up_bloc.dart' as _i23;
...
import 'package:kozak/shared/bloc/authentication_services/authentication_services_cubit.dart'
    as _i26;
import 'package:kozak/shared/bloc/feedback/feedback_bloc.dart' as _i21;
...
import 'package:kozak/shared/repositories/firebase_module.dart' as _i28;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i19.HomeWatcherBloc>(
        () => _i19.HomeWatcherBloc(homeRepository: gh<_i11.IHomeRepository>()));
    gh.factory<_i20.InformationWatcherBloc>(() => _i20.InformationWatcherBloc(
        informationRepository: gh<_i11.IInformationRepository>()));
    gh.factory<_i21.FeedbackBloc>(() =>
        _i21.FeedbackBloc(feedbackRepository: gh<_i11.IFeedbackRepository>()));
    gh.singleton<_i11.IAppAuthenticationRepository>(
        () => _i22.AppAuthenticationRepository(
              gh<_i11.IStorage>(),
              gh<_i9.FirebaseAuth>(),
    ...
    gh.singleton<_i24.AuthenticationRepository>(() =>
        _i24.AuthenticationRepository(gh<_i11.IAppAuthenticationRepository>()));
    gh.factory<_i25.LoginBloc>(() => _i25.LoginBloc(
        authenticationRepository: gh<_i11.AuthenticationRepository>()));
    gh.factory<_i26.AuthenticationServicesCubit>(() =>
        _i26.AuthenticationServicesCubit(
            authenticationRepository: gh<_i11.AuthenticationRepository>()));
    gh.singleton<_i27.AuthenticationBloc>(() => _i27.AuthenticationBloc(
        authenticationRepository: gh<_i11.AuthenticationRepository>()));
    return this;
  }
}
