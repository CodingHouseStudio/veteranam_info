...
import 'package:kozak/components/investors/bloc/investors_watcher_bloc.dart'
    as _i14;
import 'package:kozak/components/login/bloc/login_bloc.dart' as _i27;
import 'package:kozak/components/sign_up/bloc/sign_up_bloc.dart' as _i25;
import 'package:kozak/components/story/bloc/story_watcher_bloc.dart' as _i17;
import 'package:kozak/components/story_add/bloc/story_add_bloc.dart' as _i23;
...
import 'package:kozak/shared/bloc/authentication_services/authentication_services_cubit.dart'
    as _i28;
import 'package:kozak/shared/bloc/feedback/feedback_bloc.dart' as _i24;
...
import 'package:kozak/shared/repositories/firebase_module.dart' as _i30;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i9.IInvestorsRepository>(() => _i12.InvestorsRepository());
    gh.singleton<_i9.IHomeRepository>(() => _i13.HomeRepository());
    ...
    gh.singleton<_i9.IStoryRepository>(() => _i16.StoryRepository());
    gh.factory<_i17.StoryWatcherBloc>(() =>
        _i17.StoryWatcherBloc(storyRepository: gh<_i9.IStoryRepository>()));
    gh.singleton<_i9.IFeedbackRepository>(() => _i18.FeedbackRepository());
    ...
    gh.factory<_i20.HomeWatcherBloc>(
        () => _i20.HomeWatcherBloc(homeRepository: gh<_i9.IHomeRepository>()));
    ...
    gh.factory<_i23.StoryAddBloc>(() => _i23.StoryAddBloc(
    ...
    gh.singleton<_i26.AuthenticationRepository>(() =>
        _i26.AuthenticationRepository(gh<_i9.IAppAuthenticationRepository>()));
    gh.factory<_i27.LoginBloc>(() => _i27.LoginBloc(
        authenticationRepository: gh<_i9.AuthenticationRepository>()));
    gh.factory<_i28.AuthenticationServicesCubit>(() =>
        _i28.AuthenticationServicesCubit(
            authenticationRepository: gh<_i9.AuthenticationRepository>()));
    gh.singleton<_i29.AuthenticationBloc>(() => _i29.AuthenticationBloc(
        authenticationRepository: gh<_i9.AuthenticationRepository>()));
    return this;
  }
}
