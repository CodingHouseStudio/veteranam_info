...
import 'package:kozak/shared/bloc/filter/filter_cubit.dart' as _i5;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i5.FilterCubit>(() => _i5.FilterCubit());
    ...
    gh.factory<_i18.WorkEmployeeWatcherBloc>(() => _i18.WorkEmployeeWatcherBloc(
        workRepository: gh<_i10.IWorkRepository>()));
    gh.factory<_i19.HomeWatcherBloc>(
        () => _i19.HomeWatcherBloc(homeRepository: gh<_i10.IHomeRepository>()));
    ...
    gh.factory<_i21.FeedbackBloc>(() =>
        _i21.FeedbackBloc(feedbackRepository: gh<_i10.IFeedbackRepository>()));
    ...
    gh.singleton<_i24.AuthenticationRepository>(() =>
        _i24.AuthenticationRepository(gh<_i10.IAppAuthenticationRepository>()));
