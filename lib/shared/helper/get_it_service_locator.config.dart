...
import 'package:veteranam/shared/bloc/authentication_services/authentication_services_cubit.dart'
    as _i33;
import 'package:veteranam/shared/bloc/report/report_bloc.dart' as _i35;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i30.EmployeeRespondBloc>(() => _i30.EmployeeRespondBloc(
        employeeRespondRepository: gh<_i8.IWorkRepository>()));
    gh.factory<_i31.MyDiscountsWatcherBloc>(() => _i31.MyDiscountsWatcherBloc(
          discountRepository: gh<_i8.IDiscountRepository>(),
          iAppAuthenticationRepository: gh<_i8.IAppAuthenticationRepository>(),
        ));
    gh.factory<_i32.WorkEmployeeWatcherBloc>(() => _i32.WorkEmployeeWatcherBloc(
