...
import 'package:kozak/components/login/bloc/login_bloc.dart' as _i19;
import 'package:kozak/components/sign_up/bloc/sign_up_bloc.dart' as _i17;
...
import 'package:kozak/shared/bloc/authentication_services/authentication_services_cubit.dart'
    as _i20;
import 'package:kozak/shared/bloc/feedback/feedback_bloc.dart' as _i15;
...
import 'package:kozak/shared/repositories/firebase_module.dart' as _i22;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i10.IFeedbackRepository>(() => _i13.FeedbackRepository());
    gh.factory<_i14.HomeWatcherBloc>(
        () => _i14.HomeWatcherBloc(homeRepository: gh<_i10.IHomeRepository>()));
    gh.factory<_i15.FeedbackBloc>(() =>
        _i15.FeedbackBloc(feedbackRepository: gh<_i10.IFeedbackRepository>()));
    ...
    gh.singleton<_i18.AuthenticationRepository>(() =>
        _i18.AuthenticationRepository(gh<_i10.IAppAuthenticationRepository>()));
    gh.factory<_i19.LoginBloc>(() => _i19.LoginBloc(
        authenticationRepository: gh<_i10.AuthenticationRepository>()));
    gh.factory<_i20.AuthenticationServicesCubit>(() =>
        _i20.AuthenticationServicesCubit(
            authenticationRepository: gh<_i10.AuthenticationRepository>()));
    gh.singleton<_i21.AuthenticationBloc>(() => _i21.AuthenticationBloc(
        authenticationRepository: gh<_i10.AuthenticationRepository>()));
    return this;
  }
}
