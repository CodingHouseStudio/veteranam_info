...
import 'package:kozak/components/employee_respond/bloc/employee_respond_bloc.dart'
    as _i25;
import 'package:kozak/components/home/bloc/home_watcher_bloc.dart' as _i24;
...
import 'package:kozak/components/investors/bloc/investors_watcher_bloc.dart'
    as _i17;
import 'package:kozak/components/login/bloc/login_bloc.dart' as _i34;
import 'package:kozak/components/my_story/bloc/my_story_watcher_bloc.dart'
    as _i28;
import 'package:kozak/components/sign_up/bloc/sign_up_bloc.dart' as _i32;
import 'package:kozak/components/story/bloc/story_watcher_bloc.dart' as _i20;
import 'package:kozak/components/story_add/bloc/story_add_bloc.dart' as _i29;
...
import 'package:kozak/shared/bloc/authentication_services/authentication_services_cubit.dart'
    as _i35;
import 'package:kozak/shared/bloc/feedback/feedback_bloc.dart' as _i31;
...
import 'package:kozak/shared/repositories/authentication_repository.dart'
    as _i33;
import 'package:kozak/shared/repositories/discount_repository.dart' as _i14;
import 'package:kozak/shared/repositories/feedback_repository.dart' as _i22;
import 'package:kozak/shared/repositories/firebase_module.dart' as _i37;
import 'package:kozak/shared/repositories/home_repository.dart' as _i16;
import 'package:kozak/shared/repositories/information_repository.dart' as _i18;
import 'package:kozak/shared/repositories/investors_repository.dart' as _i15;
import 'package:kozak/shared/repositories/secure_storage_repository.dart'
    as _i13;
import 'package:kozak/shared/repositories/story_repository.dart' as _i19;
import 'package:kozak/shared/repositories/tags_repository.dart' as _i21;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i11.IDiscountRepository>(() => _i14.DiscountRepository());
    gh.singleton<_i11.IInvestorsRepository>(() => _i15.InvestorsRepository());
    gh.singleton<_i11.IHomeRepository>(() => _i16.HomeRepository());
    gh.factory<_i17.InvestorsWatcherBloc>(() => _i17.InvestorsWatcherBloc(
        investorsRepository: gh<_i11.IInvestorsRepository>()));
    gh.singleton<_i11.IInformationRepository>(
        () => _i18.InformationRepository());
    gh.singleton<_i11.IStoryRepository>(() => _i19.StoryRepository());
    gh.factory<_i20.StoryWatcherBloc>(() =>
        _i20.StoryWatcherBloc(storyRepository: gh<_i11.IStoryRepository>()));
    gh.singleton<_i11.ITagsRepository>(() => _i21.TagsRepository());
    gh.singleton<_i11.IFeedbackRepository>(() => _i22.FeedbackRepository());
    gh.factory<_i23.WorkEmployeeWatcherBloc>(() => _i23.WorkEmployeeWatcherBloc(
        workRepository: gh<_i11.IWorkRepository>()));
    gh.factory<_i24.HomeWatcherBloc>(
        () => _i24.HomeWatcherBloc(homeRepository: gh<_i11.IHomeRepository>()));
    gh.factory<_i25.EmployeeRespondBloc>(() => _i25.EmployeeRespondBloc(
        employeeRespondRepository: gh<_i11.IWorkRepository>()));
    gh.factory<_i26.InformationWatcherBloc>(() => _i26.InformationWatcherBloc(
        informationRepository: gh<_i11.IInformationRepository>()));
    gh.singleton<_i11.IAppAuthenticationRepository>(
        () => _i27.AppAuthenticationRepository(
              gh<_i11.IStorage>(),
              gh<_i9.FirebaseAuth>(),
    ...
    gh.factory<_i29.StoryAddBloc>(() => _i29.StoryAddBloc(
          storyRepository: gh<_i11.IStoryRepository>(),
          iAppAuthenticationRepository: gh<_i11.IAppAuthenticationRepository>(),
        ));
    gh.factory<_i30.DiscountWatcherBloc>(() => _i30.DiscountWatcherBloc(
        discountRepository: gh<_i11.IDiscountRepository>()));
    gh.factory<_i31.FeedbackBloc>(() => _i31.FeedbackBloc(
          feedbackRepository: gh<_i11.IFeedbackRepository>(),
          appAuthenticationRepository: gh<_i11.IAppAuthenticationRepository>(),
        ));
    gh.factory<_i32.SignUpBloc>(() => _i32.SignUpBloc(
        iAppAuthenticationRepository: gh<_i11.IAppAuthenticationRepository>()));
    gh.singleton<_i33.AuthenticationRepository>(() =>
        _i33.AuthenticationRepository(gh<_i11.IAppAuthenticationRepository>()));
