...
import 'package:kozak/components/discounts/bloc/discount_watcher_bloc.dart'
    as _i28;
import 'package:kozak/components/home/bloc/home_watcher_bloc.dart' as _i23;
...
import 'package:kozak/shared/repositories/authentication_repository.dart'
    as _i31;
import 'package:kozak/shared/repositories/discount_repository.dart' as _i13;
import 'package:kozak/shared/repositories/feedback_repository.dart' as _i21;
...
import 'package:kozak/shared/repositories/tags_repository.dart' as _i20;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i10.IDiscountRepository>(() => _i13.DiscountRepository());
    gh.singleton<_i10.IInvestorsRepository>(() => _i14.InvestorsRepository());
    gh.singleton<_i10.IHomeRepository>(() => _i15.HomeRepository());
    ...
    gh.singleton<_i10.IStoryRepository>(() => _i18.StoryRepository());
    gh.factory<_i19.StoryWatcherBloc>(() =>
        _i19.StoryWatcherBloc(storyRepository: gh<_i10.IStoryRepository>()));
    gh.singleton<_i10.ITagsRepository>(() => _i20.TagsRepository());
    gh.singleton<_i10.IFeedbackRepository>(() => _i21.FeedbackRepository());
    gh.factory<_i22.WorkEmployeeWatcherBloc>(() => _i22.WorkEmployeeWatcherBloc(
        workRepository: gh<_i10.IWorkRepository>()));
    gh.factory<_i23.HomeWatcherBloc>(
        () => _i23.HomeWatcherBloc(homeRepository: gh<_i10.IHomeRepository>()));
    ...
    gh.singleton<_i31.AuthenticationRepository>(() =>
        _i31.AuthenticationRepository(gh<_i10.IAppAuthenticationRepository>()));
