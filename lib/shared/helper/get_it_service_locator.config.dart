...
import 'package:kozak/components/home/bloc/home_watcher_bloc.dart' as _i20;
...
import 'package:kozak/components/sign_up/bloc/sign_up_bloc.dart' as _i24;
...
import 'package:kozak/shared/bloc/authentication_services/authentication_services_cubit.dart'
    as _i27;
import 'package:kozak/shared/bloc/feedback/feedback_bloc.dart' as _i22;
...
import 'package:kozak/shared/repositories/authentication_repository.dart'
    as _i25;
import 'package:kozak/shared/repositories/feedback_repository.dart' as _i18;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i11.IFeedbackRepository>(() => _i18.FeedbackRepository());
    gh.factory<_i19.WorkEmployeeWatcherBloc>(() => _i19.WorkEmployeeWatcherBloc(
        workRepository: gh<_i11.IWorkRepository>()));
    gh.factory<_i20.HomeWatcherBloc>(
        () => _i20.HomeWatcherBloc(homeRepository: gh<_i11.IHomeRepository>()));
    gh.factory<_i21.InformationWatcherBloc>(() => _i21.InformationWatcherBloc(
        informationRepository: gh<_i11.IInformationRepository>()));
    gh.factory<_i22.FeedbackBloc>(() =>
        _i22.FeedbackBloc(feedbackRepository: gh<_i11.IFeedbackRepository>()));
    gh.singleton<_i11.IAppAuthenticationRepository>(
        () => _i23.AppAuthenticationRepository(
              gh<_i11.IStorage>(),
              gh<_i9.FirebaseAuth>(),
    ...
    gh.singleton<_i25.AuthenticationRepository>(() =>
        _i25.AuthenticationRepository(gh<_i11.IAppAuthenticationRepository>()));
