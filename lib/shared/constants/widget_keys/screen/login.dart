...
class _LoginKeys {
  final screen = const Key('login_screen');
  final card = const Key('login_screen_card');
  ...
  final submitingText = const Key('login_screen_submiting_text');
  // final loadingText = const Key('login_screen_loading_text');
