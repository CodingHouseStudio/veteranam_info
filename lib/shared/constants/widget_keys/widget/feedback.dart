...
class _FeedbackKeys {
  final title = const Key('feedback_title');
  final subtitle = const Key('feedback_subtitle');
  final name = const Key('feedback_name');
  final email = const Key('feedback_email');
  final message = const Key('feedback_message');
