...
import '../../../../test/test_dependency.dart';
...
Future<void> reportDialogHelper(
  ...
  await changeWindowSizeHelper(
    ...
    test: () async {
      expect(
        find.byKey(KWidgetkeys.widget.reportDialog.title),
        findsOneWidget,
      );

      expect(
        find.byKey(KWidgetkeys.widget.reportDialog.subtitle),
        findsOneWidget,
      );
      ...
      // expect(find.byKey(KWidgetkeys.widget.reportDialog.title),
      // findsNothing);
