...
exclude_patterns = [
    ...
    r'lib/shared/constants/extension/failure_extension.dart',
    ...
    r'lib/shared/constants/extension/extension_constants.dart',
    r'lib/shared/constants/extension/list_extension.dart',
